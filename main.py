...
if __name__ == '__main__':
    ...
    terminnal_command = "python3 test_generator.py --test_name test1 --tocg_checkpoint eval_models/weights/v0.1/mtviton.pth --gpu_ids 0 --gen_checkpoint eval_models/weights/v0.1/gen.pth --datasetting unpaired --data_list t2.txt --dataroot ./test" 
    os.system(terminnal_command)
